<footer class="main-footer sticky footer-type-1">
                <div class="footer-inner">
					...
					<!--底部修改开始-->
                    &copy; <?php echo date('Y'); ?>&nbsp;Theme:<b><?php $this->options->zmki_r(); ?></b>
                    &nbsp;   Design BY <a href="https://www.liv7.com/" target="_blank"><strong>liv7.com</strong></a>
                    &nbsp;&nbsp;版权所有-<a rel="nofollow" href="http://civs.cc" target="_blank"><strong>CiVS.CC</strong></a>
