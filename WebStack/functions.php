...
<?php
    ...
    // Icon接口
    $link_icon = new Typecho_Widget_Helper_Form_Element_Text('link_icon', NULL, 'https://civs.cc/favicon/get.php?url=', _t('自动获取Icon api'), _t('自动获取icon，如链接logo
为空，则程序自动获取手动填写的Icon图标。此功能依赖于API接口<br>默认：https://civs.cc/favicon/get.php?url= <br>更多查看 <a href="https://www.zmki.cn/doc/webstack-doc">导航帮助</a> <br>注意：此功能加载速度受限于api速度，如站点内容较大，可自建icon图片接口 <a href="https://www.zmki.cn/doc/33771.html">自建icon图片接口教程</a>'));
    ...
    // 悬浮窗QQ
    $fk_zmki_qq = new Typecho_Widget_Helper_Form_Element_Text('fk_zmki_qq', NULL, '77269617', _t('悬浮窗QQ'), _t('输入右下角悬浮窗内的qq，默认 77269617，此功能需开启悬浮窗才会显示'));
