...
<!-- 独立页面缩略名称-->
                        <section class="typecho-post-option">
                            ...
                            <p><input type="text" id="order" name="slug" value="<?php $page->slug(); ?>"
                                      class="w-100"/></p>
                            <p class="description"><?php _e('为你的自定义页面自定义一个缩略名,可以自定webstack主题自定义页面左侧图标,参考:<a href="https://fontawesome.com/v4/icons/">The ico</a>'); ?></p>
                        </section>
